...
This is the React/typescript from end for mission control service.

# Backend
The backend is written in java located at "../mission-control-service"
All endpoints are enumerated in "../mission-control-service/ENDPOINTS.md"
